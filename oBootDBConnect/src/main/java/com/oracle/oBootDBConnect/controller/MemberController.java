...
public class MemberController {
	...
	private final MemberService memberService; // 인스턴스화 된 MemberService
	
	@Autowired
	public MemberController(MemberService memberService) { // 컨테이너에 있는 MemberService를 멤버변수로 사용 (인스턴스화)
