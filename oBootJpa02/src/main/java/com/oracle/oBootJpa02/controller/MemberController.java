...
//		System.out.println("memberList.get(1).getTeme().getName()->"+memberList.get(1).getTeam().getName());
	...
	public String memberModifyForm(Member member3, Model model) {
		System.out.println("MemberController memberModifyForm id->"+member3.getId());
		...
		System.out.println("mmemberModifyForm member->"+member);
