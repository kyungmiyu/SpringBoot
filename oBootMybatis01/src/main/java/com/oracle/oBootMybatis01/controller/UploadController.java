...
public class UploadController {
	...
	// Controller 내부에서만 사용 private
	private String uploadFile(String originalName, InputStream inputStream, String uploadPath, String suffix) throws IOException, ServletException  {
...
//		tempFile.deleteOnExit();
	...
	public String uploadFileDelete(HttpServletRequest request, Model model) throws Exception {
		String uploadPath = request.getSession().getServletContext().getRealPath("/upload/");
		String deleteFile = "c:/backup/" + "b909ac45-cd6b-4837-9f0d-bf21de8ca29f_Image20240215142612.jpg";
		...
		// DML Service 연동
		// delResult > 0 --> ex) update member(Img) 
